package com.salesianostriana.dam.e06fechas.servicios.base;
 ...
 * De esta forma, los métodos CRUD más habituales, ya los tenemos implementados, 
 * y solamente necesitaremos implementar por nuestra cuenta 
...
public abstract class BaseService<T, ID, R extends JpaRepository<T, ID>> {
	...
	public T findById(ID id) {
		...
		//se podría hacer también con Optional usando el siguiente código
		/*
		 * 	@Override
